...
export const setLogSchema = z.object({
  ...
  done: z.boolean(), amrap: z.boolean().optional(), assistKg: z.number().nullable().optional(), bandKg: z.number().nullable().optional(), holdSec: z.number().nullable().optional()
})
...
export const inventorySchema = z.object({
  ...
  kettlebells: z.array(z.number()), bands: z.array(z.number()), dipBelt: z.boolean()
})
...
export const appStateSchema = z.object({
  ...
  pullup: z.object({ stage: z.number(), consecutiveHits: z.number(), tests: z.array(z.object({ date: z.string(), strictReps: z.number() })), assistKg: z.number().nullable().optional() }),

...
export const TEMPLATES: DayTemplate[] = [
  { id: 'bracos_a', nome: 'Braços A', kind: 'lift', groups: ['biceps', 'triceps', 'ombros'], blocks: [
    ...
    { exerciseId: 'elevacao_lateral', sets: 3, pairedWith: 'face_pull_banda' },
    { exerciseId: 'face_pull_banda', sets: 3, pairedWith: 'elevacao_lateral' }
  ] },
  { id: 'pernas_a', nome: 'Pernas A', kind: 'lift', groups: ['quadriceps', 'posterior_gluteos', 'panturrilha'], blocks: [
    ...
    { exerciseId: 'agachamento_banda', sets: 3 },
    { exerciseId: 'panturrilha', sets: 4 }
  ] },
  { id: 'puxar_a', nome: 'Puxar A + escada', kind: 'lift', groups: ['costas', 'biceps', 'ombros'], blocks: [
    { exerciseId: 'escada_barra', sets: 4 },
    { exerciseId: 'remada_apoiada', sets: 4 },
    { exerciseId: 'face_pull_banda', sets: 3 },
  ...
  { id: 'empurrar', nome: 'Empurrar', kind: 'lift', groups: ['peito', 'triceps'], blocks: [
    ...
    { exerciseId: 'flexao_banda', sets: 3 },
  ...
  { id: 'bracos_b', nome: 'Braços B + escada', kind: 'lift', groups: ['biceps', 'triceps', 'costas', 'ombros'], blocks: [
...
export const WEEK_LAYOUT: Record<WeekMode, string[]> = {
  '6x45': ['bracos_a', 'pernas_a', 'puxar_a', 'empurrar', 'pernas_b', 'bracos_b', 'descanso'],
